...
<body>
    ...
    <div class="container">
        <div class="card border-dark mb-3">
            ...
            ?>
            <table class="table table-stripped text-white" style="background-color: #344CB7;">
                <thead>
                    <tr>
                    <th scope="col">No</th>
            ...
            <a href="checkout.php" type="button" class="btn text-white" style="background-color: #344CB7;">Checkout</a>
            <?php } ?>
            </div>
        </div>
    </div>
