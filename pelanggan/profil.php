...
<body>
    <?php
        ...
        <a href="home.php" class="btn text-white" style="background-color: #344CB7;">Kembali ke halaman utama</a>
        <div style="float: right;">
        <a
            href="ubah_pelanggan.php?id_pelanggan=<?=$data_pelanggan['id_pelanggan']?>"
            class="btn text-white" style="background-color: #344CB7;">Ubah Akun Ini</a> | <a
