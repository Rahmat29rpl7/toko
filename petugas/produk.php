...
<body>
    ...
    <h1 class= "text-center">Data Produk</h1>
        ...
        <input class="form-control me-2" type="search" name="cari" placeholder="Search" aria-label="Search">
            <button class="btn text-white" style="background-color: #344CB7;" type="submit">Search</button>
        </form>
        </div>
    <div class="card-body">
        <table class="table table-striped text-white" style="background-color: #344CB7;">
    <thead>
        <tr>
  ...
  <tbody>
    ...
    <td><a href="tambah_produk.php" class="btn text-white" style="background-color: #344CB7;">Tambah Produk</a></td>
    </div>
        </div>
    </div>
